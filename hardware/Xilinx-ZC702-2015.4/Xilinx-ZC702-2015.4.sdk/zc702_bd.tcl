...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_1_axi_periph_M00_AXI [get_bd_intf_pins leds_4bits/S_AXI] [get_bd_intf_pins processing_system7_1_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_1_FCLK_CLK0 [get_bd_pins leds_4bits/s_axi_aclk] [get_bd_pins processing_system7_1/FCLK_CLK0] [get_bd_pins processing_system7_1/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_1_axi_periph/ACLK] [get_bd_pins processing_system7_1_axi_periph/M00_ACLK] [get_bd_pins processing_system7_1_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_1_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_1_FCLK_RESET0_N [get_bd_pins processing_system7_1/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_1_50M/ext_reset_in]
  ...
  connect_bd_net -net rst_processing_system7_1_50M_peripheral_aresetn [get_bd_pins leds_4bits/s_axi_aresetn] [get_bd_pins processing_system7_1_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_1_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_1_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs leds_4bits/S_AXI/Reg] SEG_leds_4bits_Reg
